...
def get_departures(station_id):
    return mvg_api.get_depatures(station_id)
...
def navigate_between(source_name, destination_name):
    starting_station_id = get_id_of_station(source_name)
    destination_station_id= get_id_of_station(destination_name)
    return mvg_api.get_route(starting_station_id, destination_station_id)
